...
var _ViiHostSoicialNetworkWebApplicaton = _interopRequireDefault(
  require('../../../assets/images/fulls/ViiHost-Soicial-Network-Web-Applicaton.png')
)

var _KissaneAssociatesImage = _interopRequireDefault(
  require('../../../assets/images/fulls/Kissane-Associates-image.png')
)

var _PhoThaiExpressRestaurant = _interopRequireDefault(
  require('../../../assets/images/fulls/Pho-Thai-Express-Restaurant.png')
)

var _TodayPlanFullStackApp = _interopRequireDefault(
  require('../../../assets/images/fulls/Today-Plan-Full-Stack-App.png')
)

var _ViiHostSoicialNetworkWebApplicaton2 = _interopRequireDefault(
  require('../../../assets/images/thumbs/ViiHost-Soicial-Network-Web-Applicaton.png')
)

var _KissaneAssociatesImage2 = _interopRequireDefault(
  require('../../../assets/images/thumbs/Kissane-Associates-image.png')
)

var _PhoThaiExpressRestaurant2 = _interopRequireDefault(
  require('../../../assets/images/thumbs/Pho-Thai-Express-Restaurant.png')
)

var _TodayPlanFullStackApp2 = _interopRequireDefault(
  require('../../../assets/images/thumbs/Today-Plan-Full-Stack-App.png')
)
...
var DEFAULT_IMAGES = [
  {
    ...
    description:
      "This application lets you easily add and delete your own authentication plans with Microsoft Azure's authentication system.",
